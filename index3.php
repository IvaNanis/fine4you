	...
	<div id="form_container">
		...
		<form id="form_1075005" class="appnitro"  method="post" action="login.php">
			...
			<ul >
					...
					<li id="li_1" >
					  <label class="description" for="element_1">Numero de Usuario</label>
					  <div>
...
$usuario = $con->real_escape_string($us);
$contrasena = $con->real_escape_string($password);


// SQL query to fetch information of registerd users and finds user match.
$query = $con->query("select * from usuario where password='$contrasena' AND cc='$usuario'");
$rows = $query->num_rows;
if ($rows == 1) {
$r=$query->fetch_array();
$nom = $r['nombre'];
